<?php
  ...
  echo "<div class='comment__content'>$comment</div>";
    if($_SERVER["SCRIPT_NAME"] === '/group1/ishin4554/w11/index.php' && $is_login && $post_user_id === $user_id){
    ...
    } else if ($_SERVER["SCRIPT_NAME"] === '/group1/ishin4554/w11/backstage.php' && $permission !== 'noraml') {
      echo "<a method='GET' href='./handle_delete_post.php?id=$post_id'>delete</a>";
      echo "<a method='GET' href='./update_post.php?id=$post_id'>edit</a>";
    }
  echo "</div>";
